...
namespace LemonadeStand
{
    class Program
    {
        ...
        {
            // play the game online for a bit to get familiar with the gameplay.
            // make good, consistent commits.
            // basic Lemonade Stand gameplay to be present.
            ...
            // daily profit or loss displayed at the end of each day, so that I know how much money my lemonade stand has made.I also want my total profit or loss to be a running total that is displayed at the end of each day, so that I know how much money my lemonade stand has made.
            // implement the SOLID design principles as well as C# best practices in my project, so that project is as well-designed as possible.
            // pinpoint at least two places where I used one of the SOLID design principles and discuss my reasoning, so that I can properly understand good code design.Minimum of two SOLID design principles must be used.
            // connect my console application to a database so that I can save “high scores” in the form of a player’s name and their final score (profit).
